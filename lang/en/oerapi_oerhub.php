...
$string['mediatypeiconsetting'] = 'Mediatype mapping';
$string['mediatypeiconsettingdesc'] = 'Key/Value pair in JSON style, where key is the mediatype in oerhub and value is the moodle icon. e.g. "pdf":"f/pdf"';
